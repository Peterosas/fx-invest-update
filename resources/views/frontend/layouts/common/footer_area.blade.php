        ...
        <div class="footer_top">
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-3">
                        <div class="footer_widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="{{ asset('pages') }}/img/footer_logo.png" alt="">
                                </a>
                            </div>
                            <p>
                                {{ config('company.support.email') }} <br>
                                {{ config('company.phone.us1') }}<br>
                    ...
                    <div class="col-6 col-xl-2 col-md-6 col-lg-3">
                    ...
                    <div class="col-6 col-xl-2 col-md-6 col-lg-2">
